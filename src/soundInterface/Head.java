...
/**
 * Class Head is and extension of Thread. This class plays different tunes
...
public class Head {
	...
	/**
	 * Defines different tunes using different subclasses. Success: Plays scene1 -
	 * Pickup: Plays scene2 - Search: Plays scene3 - Target: Plays scene4
	 */
	public Head() {
