...
/**
 * This Class is purely for manual remote control of the robot and is not connected to the other classes.
 * @author C0mmunist1
 *
 */

public class IRSCheckerThread extends Thread {
	...
	public IRSCheckerThread(final EV3IRSensor sensor) {
